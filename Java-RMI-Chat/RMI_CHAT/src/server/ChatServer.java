...
public class ChatServer extends UnicastRemoteObject implements ChatServerIF {
	...
	private void registerChatter(String[] details){		
		try{
			...
			nextClient.messageFromServer("************** Salut " + details[0] + " **************.\n");
			
			sendToAll(details[0] + " a rejoint le Salon de chat.\n");
	 ...
	 */
	@Override
	public void sendPM(int[] privateGroup, String privateMessage, String you) throws RemoteException{
		Chatter pc;
		...
		for(Chatter c : chatters){
			if(c.getName().equals(you)){
				c.getClient().messageFromServer(privateMessage);
				break;
			}
		}
	}
